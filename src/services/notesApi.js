const BASE_URL = "https://notes-backend-pearl-alpha.vercel.app";
...
export const updateNote = async (_id, noteData) => {
  const response = await fetch(
    `https://notes-backend-pearl-alpha.vercel.app/update/notes/${_id}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export const permanentDelete = async (_id) => {
  const response = await fetch(`https://notes-backend-pearl-alpha.vercel.app/delete/notes/${_id}`, {
    method: "DELETE",
  });
